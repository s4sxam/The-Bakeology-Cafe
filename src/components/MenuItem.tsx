    ...
    >
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-start justify-between gap-4">
          <p className="text-[#A39F98] text-sm font-light leading-relaxed pr-8 flex-1 italic">
            {item.description}
          </p>
          <button
            onClick={() => addToCart(item)}
            className="w-10 h-10 shrink-0 rounded-full border border-[#2B2620] flex items-center justify-center text-[#D4A373] hover:text-[#0C0804] hover:bg-[#D4A373] hover:border-[#D4A373] transition-all duration-300 cursor-pointer"
          >
