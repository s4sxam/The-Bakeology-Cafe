  ...
  return (
    <section id="menu" className="py-32 bg-[#0C0804] relative">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        >
          <span className="text-[#D4A373] font-inter tracking-[0.3em] text-xs md:text-sm uppercase mb-4 block font-bold">
            OUR CRAFT
          </span>
          <h2 className="text-4xl md:text-5xl font-playfair italic text-[#FDFBF7] mb-6">The Menu Explorer</h2>
